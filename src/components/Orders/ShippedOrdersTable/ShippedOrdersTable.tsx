...
import { SHIPPED_ORDERS_API_URL } from '../../../constants'
import { useGetOrders } from '../../../hooks/Orders/useGetOrders'
import { Order } from '../../../types/dto/order/Order'

interface Props {}

export const ShippedOrdersTable: FunctionComponent<Props> = props => {
    const { orders, loading } = useGetOrders(SHIPPED_ORDERS_API_URL)
